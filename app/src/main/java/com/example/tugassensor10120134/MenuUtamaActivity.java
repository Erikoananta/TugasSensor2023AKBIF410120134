package com.example.tugassensor10120134;
...
import com.example.tugassensor10120134.databinding.ActivityMenuUtamaBinding;
...
public class MenuUtamaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_clocation, R.id.nav_5location, R.id.nav_profile)
